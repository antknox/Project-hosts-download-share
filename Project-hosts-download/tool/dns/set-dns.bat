...
:netsh interface ip add dns "网络连接" DNS地址 index=2
:netsh interface ip set dns "网络连接名" static 202.216.224.66
:netsh interface ip add dns "网络连接名" 202.216.224.67 index=2
...
echo 添加dns
:netsh interface ip set dns help
netsh interface ip set dns "以太网 5" static 127.0.0.1
:netsh interface ip set dns "以太网 5" dhcp

echo 添加备用dns
:netsh interface ip add dns help
netsh interface ip add dns "以太网 5" 119.29.29.29 index=2
